...
with row1_left:
    ...
    if not df.empty and "latency_ms" in df.columns:
        ...
        st.info("No latency data yet. Start asking questions to the agent.")
...
with col_admin2:
    st.caption("Use 'Clear Metrics' to reset the dashboard. Next query will create a fresh session.")
